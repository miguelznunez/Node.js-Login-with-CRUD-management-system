...
activateAccountEmail = (email, id, token, cb) => {
  ...
  var mailOptions = {
      ...
      html: `<p>Please click on the following link, or paste it into your browser to complete the account activation process:<br><br><a href="http://localhost:5000/auth/account-verification/${id}/${token}">http://localhost:5000/auth/account-verification/${id}/${token}</a><br><br>The Team</p>`
